...
uses
  ...
  WebModule.Main in 'src\service\WebModule.Main.pas' {WMMain: TWebModule},
  Model.Customer in 'src\model\Model.Customer.pas',
  Factory.Connection in 'src\factory\connection\Factory.Connection.pas',
  Factory.FDConnection in 'src\factory\connection\Factory.FDConnection.pas';
